...
const navigation = [
  ...
  },
  {
    ...
    icon: Warehouse,
    items: [
      { title: '进销存报表', href: '/inventory/psa' },
      { title: '总部采购入库', href: '/inventory/purchase' },
      { title: '店铺采购申请', href: '/inventory/store-requests' },
      { title: '库存调拨', href: '/inventory/transfer' },
      { title: '库存记录', href: '/inventory' },
      { title: '供应商管理', href: '/inventory/suppliers' },
      { title: '库存盘点', href: '/inventory/stocktakes' },
    ],
  },
  {
    title: '商品管理',
  ...
  },
  {
    ...
    items: [
      ...
      { title: '退款订单', href: '/orders/refunds' },
      { title: '挂单记录', href: '/orders/pending' },
    ],
  },
  {
    title: '会员管理',
    icon: Users,
    items: [
      { title: '统一会员管理', href: '/members/unified' },
      { title: '会员列表', href: '/members' },
      { title: '会员等级', href: '/customers/membership' },
      { title: '积分规则', href: '/members/points' },
    ],
  },
  {
    title: '员工管理',
    icon: Users,
    items: [
      { title: '员工列表', href: '/staff' },
      { title: '绩效统计', href: '/staff/performance' },
    ],
  },
  {
    title: '营销管理',
    icon: Gift,
    items: [
      { title: '优惠券', href: '/marketing/coupons' },
      { title: '促销活动', href: '/marketing/promotions' },
    ],
  },
  {
    title: '社区团购',
    icon: UsersRound,
    items: [
      { title: '团购活动', href: '/group-buy' },
      { title: '群接龙', href: '/group-buy/dragon' },
    ],
  },
  {
    title: '外卖对接',
    icon: Truck,
    items: [
      { title: '平台管理', href: '/delivery/platforms' },
      { title: '外卖订单', href: '/delivery/orders' },
    ],
  },
  {
    title: '小程序商城',
    icon: Smartphone,
    items: [
      { title: '商城首页', href: '/marketing/mini-store' },
      { title: '分类管理', href: '/marketing/mini-store/categories' },
      { title: '商品图片', href: '/marketing/mini-store/product-images' },
      { title: '小程序订单', href: '/marketing/mini-store/orders' },
      { title: '配送管理', href: '/marketing/mini-store/delivery' },
      { title: '积分商城', href: '/marketing/mini-store/points-mall' },
    ],
  },
  {
    title: '数据报表',
    icon: BarChart3,
    items: [
      { title: '销售分析', href: '/analytics' },
      { title: '商品分析', href: '/analytics/products' },
      { title: '会员分析', href: '/analytics/members' },
      { title: '数据报表', href: '/reports/analysis' },
    ],
  },
  {
    title: '多店管理',
  ...
  },
  {
    ...
    icon: Settings,
    items: [
      { title: '店铺设置', href: '/settings/shop' },
      { title: '店长账号管理', href: '/settings/store-managers' },
      { title: '收银员管理', href: '/settings/staff' },
      { title: '打印设置', href: '/settings/printer' },
      { title: '价签打印设置', href: '/settings/label' },
      { title: '支付配置', href: '/settings/payment' },
      { title: '客显屏管理', href: '/settings/customer-display' },
      { title: 'AI功能配置', href: '/settings/ai-config' },
    ],
  },
];
