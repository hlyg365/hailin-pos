    ...
    <div className="min-h-screen bg-gray-50 flex flex-col max-w-md mx-auto relative">
              ...
              <div className="flex flex-col items-start">
                <div className="flex items-center gap-1">
                  ...
                  <span className={`text-[10px] px-1.5 py-0.5 rounded ${
                    selectedStore.isOpen ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600'
                  }`}>
      ...
      <div className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-white border-t z-40 safe-area-inset-bottom">
        <div className="flex">
          ...
          >
            <svg className="w-5 h-5" fill={activeTab === 'category' ? 'currentColor' : 'none'} stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
            </svg>
            <span className="text-[10px]">全部分类</span>
          </button>
          ...
          >
            ...
            {cartCount > 0 && (
              <span className="absolute top-0 right-3 bg-red-500 text-white text-[10px] w-4 h-4 rounded-full flex items-center justify-center">
          ...
          >
            <svg className="w-5 h-5" fill={activeTab === 'my' ? 'currentColor' : 'none'} stroke="currentColor" viewBox="0 0 24 24">
